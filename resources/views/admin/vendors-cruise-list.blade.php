...
@section('page_title','OYT-Vendors-Cruise-List')
...
<main id="main" class="main">
    ...
    <div class="col-12">
        ...
        <a href="{{url('admin/cruisevendors/')}}">
    ...
    <a href="{{url('admin/vendorpanel/')}}">
        <button type="button" class="btn btn-primary">
            ...
            <div class="card-body">
            <h1 class="mb10">Vendors - Cruise List</h1>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{url('admin/cruise/approve/')}}/{{$list->id}}"><button type="button"
                                            class="btn btn-success"
                                            style=""><i
                                                class="fa fa-check" style="color:white;"> Approve </i>
                                        </button></a>
                                    <?php } else{ ?>
                                    <a href="{{url('admin/cruise/approve/')}}/{{$list->id}}"><button
