...
<main id="main" class="main">
    ...
    <a href="{{url('admin/hotels/add-hotels')}}">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                    ...
                                    <a href="{{url('admin/hotel_images/add-hotel_images')}}/{{$list->id}}"><button type="button"
