                        ...
                        <div class="card-body">
                            <form action="insert" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-12">
                                            <label for="color" class="control-label mb-1"> Charted Plane-ID </label>
                                            <input id="p_id"  name="p_id" type="text" class="form-control" aria-required="true" aria-invalid="false" required>
                                            @error('p_id')
