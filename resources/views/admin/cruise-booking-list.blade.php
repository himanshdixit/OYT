...
@section('page_title','OYT-Cruise-Booking-List')
...
<main id="main" class="main">
    ...
    <div class="col-12">
        <div class="card recent-sales overflow-auto">
            ...
            <div class="card-body">
            <h1 class="mb10">Cruise Booking List</h1>
                ...
                <table class="table table-borderless datatable">
                    ...
                    @foreach($data as $list)
                        <tr>
                            ...
                            <td>{{$list->cruise_name}}</td>
                            <td>{{$list->price}}</td>
                            <td>{{$list->sailing_dates}}</td>
                            <td>{{$list->name}}</td>
                            <td>{{$list->email}}</td>
                            <td>{{$list->phone}}</td>
                            <td>{{$list->address}}</td>
                            ...
                            <td>
                                <img src="{{asset('uploads/cruise_items/'.$list->file_path)}}"
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                    ...
                                    <a href="{{url('admin/cruisebookingslist/cruisebookingdeleted/')}}/{{$list->id}}"><button
