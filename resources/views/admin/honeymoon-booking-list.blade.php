...
@section('page_title','OYT-honeymoon-Booking-List')
...
<main id="main" class="main">
    ...
    <div class="col-12">
        <div class="card recent-sales overflow-auto">
            ...
            <div class="card-body">
            <h1 class="mb10">Honeymoon Booking List</h1>
                ...
                <table class="table table-borderless datatable">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">honeymoon ID</th>
                            <th scope="col">honeymoon Name</th>
                    ...
                    @foreach($data as $list)
                        <tr>
                            ...
                            <td>
                                    <button type="button"
                                            class="btn btn-secondary" data-toggle="modal" data-target="#exampleModalCenter_{{ $list->hy_id }}"
                                            ><i class="fa fa-info-circle" style="color:white;"></i>
                                        </button>
                            </td>
                            <td>
                                <img src="{{asset('uploads/honeymoon/'.$list->file_path)}}"
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                    ...
                                    <a href="{{url('admin/honeymoonbookingslist/honeymoonbookingdeleted/')}}/{{$list->id}}"><button
...
<div class="modal fade" id="exampleModalCenter_{{ $list->hy_id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">{{ $list->hy_id }} - {{ $list->name }}</h5>
...
<ul id="myTab2" role="tablist" class="nav nav-tabs nav-pills with-arrow lined flex-sm-row text-center">
  ...
  <li class="nav-item flex-sm-fill">
    <a id="contact2-tab" data-toggle="tab" href="#contact2" role="tab" aria-controls="contact2" aria-selected="false" class="nav-link  " style="border:1px solid lightgrey;padding: 0.1rem 0.7rem;margin:3px;">Chart</a>
  </li>
  <li class="nav-item flex-sm-fill">
...
<div id="myTab2Content" class="tab-content">
  ...
  <b style="color:#ff3d00;">Day/Nights : {{ $list->nights }}</b>
  <b style="color:#ff3d00;">Travelers : {{ $list->travelers }}</b>
  </div>
  <div id="contact2" role="tabpanel" aria-labelledby="contact-tab" class="tab-pane fade px-2 py-2">
  <p align="justify">{!! $list->chart !!}</p>
  </div>
