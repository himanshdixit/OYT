...
@section('page_title','OYT-Vendors-Caravan-List')
...
<main id="main" class="main">
    ...
    <a href="{{url('admin/caravanvendors/')}}">
    ...
    <a href="{{url('admin/vendorpanel/')}}">
        ...
        <div class="card recent-sales overflow-auto">
            ...
            <div class="card-body">
            <h1 class="mb10">Vendors - Caravan List</h1>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{url('admin/caravan/approve/')}}/{{$list->id}}"><button type="button"
                                            class="btn btn-success"
                                            style=""><i
                                                class="fa fa-check" style="color:white;"> Approve </i>
                                        </button></a>
                                    <?php } else{ ?>
                                    <a href="{{url('admin/caravan/approve/')}}/{{$list->id}}"><button
