...
@section('page_title','OYT-Holiday-Booking-List')
...
<main id="main" class="main">
    ...
    <div class="col-12">
        <div class="card recent-sales overflow-auto">
            ...
            <div class="card-body">
            <h1 class="mb10">Holiday Booking List</h1>
                ...
                <table class="table table-borderless datatable">
                    ...
                    @foreach($data as $list)
                        <tr>
                            ...
                            <td>
                                    <button type="button"
                                            class="btn btn-secondary" data-toggle="modal" data-target="#exampleModalCenter_{{ $list->h_id }}"
                                            ><i class="fa fa-info-circle" style="color:white;"></i>
                                        </button>
                            </td>
                            <td>
                                <img src="{{asset('uploads/holiday/'.$list->file_path)}}"
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                    ...
                                    <a href="{{url('admin/holidaybookingslist/holidaybookingdeleted/')}}/{{$list->id}}"><button
...
<div class="modal fade" id="exampleModalCenter_{{ $list->h_id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">{{ $list->h_id }} - {{ $list->name }}</h5>
...
<div id="myTab2Content" class="tab-content">
  ...
  <b style="color:#ff3d00;">Day-Night : {{ $list->day_night }}</b> <br/>
  ...
  <p align="justify">{!! $list->daily_chart !!}</p>
  </div>
