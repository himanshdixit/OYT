...
@section('page_title','OYT-Golf-Booking-List')
...
<main id="main" class="main">
    ...
    <div class="col-12">
        <div class="card recent-sales overflow-auto">
            ...
            <div class="card-body">
            <h1 class="mb10">Golf Booking List</h1>
                ...
                <table class="table table-borderless datatable">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Golf Name</th>
                            <th scope="col">Price</th>

                            <th scope="col">Player</th>
                            <th scope="col">Timning</th>
                    ...
                    @foreach($data as $list)
                        <tr>
                            ...
                            <td>
                                    <button type="button"
                                            class="btn btn-secondary" data-toggle="modal" data-target="#exampleModalCenter_{{ $list->g_id }}"
                                            ><i class="fa fa-info-circle" style="color:white;"></i>
                                        </button>
                            </td>
                            <td>
                                <img src="{{asset('uploads/golf/'.$list->file_path)}}"
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                    ...
                                    <a href="{{url('admin/golfbookingslist/golfbookingdeleted/')}}/{{$list->id}}"><button
...
<div class="modal fade" id="exampleModalCenter_{{ $list->g_id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">{{ $list->g_id }} - {{ $list->name }}</h5>
...
<div id="myTab2Content" class="tab-content">
  ...
  <p align="justify">{!! $list->timing_chart !!}</p>
  </div>
