...
@section('page_title','OYT-Vendors-Wine-List')
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{url('admin/wine/approve/')}}/{{$list->id}}"><button type="button"
                                            class="btn btn-success"
                                            style=""><i
                                                class="fa fa-check" style="color:white;"> Approve </i>
                                        </button></a>
                                    <?php } else{ ?>
                                    <a href="{{url('admin/wine/approve/')}}/{{$list->id}}"><button
