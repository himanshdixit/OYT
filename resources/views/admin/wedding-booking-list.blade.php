...
@section('page_title','OYT-Wedding-Booking-List')
...
<main id="main" class="main">
    ...
    <div class="col-12">
        <div class="card recent-sales overflow-auto">
            ...
            <div class="card-body">
            <h1 class="mb10">Wedding Booking List</h1>
                ...
                <table class="table table-borderless datatable">
                    ...
                    @foreach($data as $list)
                        <tr>
                            ...
                            <td>{{$list->people}}</td>
                            <td>{{$list->rooms}}</td>
                            <td>{{$list->food_pax_type}}</td>

                            <td>{{$list->created_at}}</td>
                            <td>
                                    <button type="button"
                                            class="btn btn-secondary" data-toggle="modal" data-target="#exampleModalCenter_{{ $list->w_id }}"
                                            ><i class="fa fa-info-circle" style="color:white;"></i>
                                        </button>
                            </td>
                            <td>
                                <img src="{{asset('uploads/weddings/'.$list->file_path)}}"
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                    ...
                                    <a href="{{url('admin/weddingbookingslist/weddingbookingdeleted/')}}/{{$list->id}}"><button
...
<div class="modal fade" id="exampleModalCenter_{{ $list->w_id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">{{ $list->w_id }} - {{ $list->name }}</h5>
...
<div id="myTab2Content" class="tab-content">
  ...
  <b style="color:#ff3d00;">Venue : {{ $list->venue }}</b> <br/>
  <b style="color:#ff3d00;">Banquets : {{ $list->banquets }}</b>
  </div>
