...
@section('page_title','OYT-Cruise-Images-Add')
...
<h1 class="mb10">Add Cruise Images</h1>
    <a href="{{url('admin/cruise_images')}}/{{ $cruise_id }}">
    ...
    <div class="row m-t-30">
        ...
        <div class="row">
                <div class="col-lg-10">
                    <div class="card">
                        <div class="card-body">
                            <form action="/admin/cruise_images/insert/" method="post" enctype="multipart/form-data">
                                @csrf
