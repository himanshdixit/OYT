...
@section('page_title','OYT-Resort-Edit')
...
<h1 class="mb10">Update Resort Items</h1>
    <a href="{{url('vendor/resort')}}">
    ...
    <div class="row m-t-30">
        ...
        <div class="row">
                <div class="col-lg-10">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ url('/vendor/resort/update/'.$data['0']->id ) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-12">
                                            ...
                                            <input id="r_id"  name="r_id" type="text" class="form-control" aria-required="true" aria-invalid="false" value="{{ $data['0']->r_id}}" readonly required>
                                            @error('r_id')
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <input id="duration"  name="duration" type="text" class="form-control" aria-required="true" aria-invalid="false" value="{{ $data['0']->duration}}" required>
                                            @error('duration')
                                             <p style="color:red;">{{$message}}</p>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            @error('image')
                                                <p style="color:red;">{{$message}}</p>
                                            @enderror
                                             <img src="{{asset('uploads/resort/'.$data['0']->photo) }}" style="width: 90px; height: 70px;margin:10px;">
                                        </div>
