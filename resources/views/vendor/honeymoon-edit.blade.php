...
@section('page_title','OYT-Honeymoon-Edit')
...
<h1 class="mb10">Update Honeymoon Package</h1>
    <a href="{{url('vendor/honeymoon')}}">
    ...
    <div class="row m-t-30">
        ...
        <div class="row">
                <div class="col-lg-10">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ url('/vendor/honeymoon/update/'.$data['0']->id ) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-12">
                                            ...
                                            <input id="hy_id"  name="hy_id" type="text" class="form-control" aria-required="true" aria-invalid="false" value="{{ $data['0']->hy_id}}" readonly required>
                                            @error('hy_id')
                                        ...
                                        <option>{{ $data['0']->travelers}}</option>
                                            <option value="1">1</option>
                                            <option value="2">2</option>
                                            <option value="3">3</option>
                                            <option value="4">4</option>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <textarea id="chart" name="chart" type="text" class="form-control" aria-required="true" aria-invalid="false">{{ $data['0']->chart}}</textarea>
                                            @error('chart')
                                             <p style="color:red;">{{$message}}</p>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            @error('image')
                                                <p style="color:red;">{{$message}}</p>
                                            @enderror
                                             <img src="{{asset('uploads/honeymoon/'.$data['0']->photo) }}" style="width: 90px; height: 70px;margin:10px;">
                                        </div>
