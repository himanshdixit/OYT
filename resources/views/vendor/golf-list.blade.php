...
@section('page_title','OYT-Golf-List')
...
<main id="main" class="main">
    ...
    <div class="col-12">
        <div class="card recent-sales overflow-auto">
            ...
            <div class="card-body">
            <h1 class="mb10">Golf</h1>
    <a href="{{url('vendor/golf/add-golf')}}">
        <button type="button" class="btn btn-primary">
            Add New Golf Package
        </button>
    </a>
                ...
                <table class="table table-borderless datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <img src="{{asset('uploads/golf/'.$list->photo)}}"
                                    style="width: 100px; height: 100px;">
                            </td>

                            <td>
                                <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                    <a href="{{url('vendor/golf/edit/')}}/{{$list->id}}"><button type="button"
                                            class="btn btn-secondary"
                                            style="border-top-right-radius: 0;border-bottom-right-radius: 0;"><i
                                                class="fa fa-edit" style="color:white;"></i>
                                        </button></a>

                                    <a href="{{url('vendor/golf/delete/')}}/{{$list->id}}"><button
