...
@section('page_title','OYT-Plane-Add')
...
<h1 class="mb10">Add New Plane</h1>
                        ...
                        @endforeach
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-12">
                                            <label for="color" class="control-label mb-1"> Pilot Details (if any)</label>
                                            <input id="pilot"  name="pilot" type="text" class="form-control" aria-required="true" aria-invalid="false">
                                            @error('pilot')
                                             <p style="color:red;">{{$message}}</p>
                                            @enderror
                                        </div>
