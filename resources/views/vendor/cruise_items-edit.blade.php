    ...
    <div class="row m-t-30">
        ...
        <div class="row">
                <div class="col-lg-10">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ url('/vendor/cruise_items/update/'.$data['0']->id ) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-12">
                                            ...
                                            <input id="cruise_id"  name="cruise_id" type="text" class="form-control" aria-required="true" aria-invalid="false" value="{{ $data['0']->cruise_id}}" readonly required>
                                        </div>
