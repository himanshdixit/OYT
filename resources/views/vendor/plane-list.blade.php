...
@section('page_title','OYT-Charted-Plane-List')
...
<main id="main" class="main">
    ...
    <div class="col-12">
        <div class="card recent-sales overflow-auto">
            ...
            <div class="card-body">
            <h1 class="mb10">Charted Planes</h1>
    <a href="{{url('vendor/plane/add-plane')}}">
