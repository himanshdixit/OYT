...
<main id="main" class="main">
    ...
    <a href="{{url('vendor/cruise_items/add-cruise_items')}}">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                    <a href="{{url('vendor/cruise_items/edit/')}}/{{$list->id}}"><button type="button"
                                            class="btn btn-secondary"
                                            style="border-top-right-radius: 0;border-bottom-right-radius: 0;"><i
                                                class="fa fa-edit" style="color:white;"></i>
                                        </button></a>

                                    <a href="{{url('vendor/cruise_items/delete/')}}/{{$list->id}}"><button
