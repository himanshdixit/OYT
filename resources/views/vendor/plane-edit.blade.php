...
@section('page_title','OYT-Plane-Edit')
...
<h1 class="mb10">Update Plane Items</h1>
    <a href="{{url('vendor/plane')}}">
    ...
    <div class="row m-t-30">
        ...
        <div class="row">
                <div class="col-lg-10">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ url('/vendor/plane/update/'.$data['0']->id ) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <div class="row">

                                    <div class="col-lg-12">
                                            <label for="color" class="control-label mb-1"> Plane-ID </label>
                                            <input id="p_id"  name="p_id" type="text" class="form-control" aria-required="true" aria-invalid="false" value="{{ $data['0']->p_id}}" readonly required>
                                            @error('p_id')
                                        ...
                                        <div class="col-lg-12">
                                            <label for="color" class="control-label mb-1"> Pilot </label>
                                            <input id="pilot"  name="pilot" type="text" class="form-control" aria-required="true" aria-invalid="false" value="{{ $data['0']->pilot}}" required>
                                            @error('pilot')
                                             <p style="color:red;">{{$message}}</p>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            @error('image')
                                                <p style="color:red;">{{$message}}</p>
                                            @enderror
                                             <img src="{{asset('uploads/plane/'.$data['0']->photo) }}" style="width: 90px; height: 70px;margin:10px;">
                                        </div>
