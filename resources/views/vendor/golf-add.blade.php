...
@section('page_title','OYT-Golf-Add')
...
<h1 class="mb10">Add New Golf Package</h1>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <textarea id="timing_chart" name="timing_chart" type="text" class="form-control" aria-required="true" aria-invalid="false"></textarea>
                                            @error('timing_chart')
                                             <p style="color:red;">{{$message}}</p>
                                            @enderror
                                        </div>
