...
const Planedetailpage=()=>{
  ...
  function getDate() {
    ...
    const handleSubmit= async (e)=>{
      ...
      // const url="http://localhost:8000/api/plane_booking";
      const url="https://oyt.travel/api/plane_booking";
      const res = await axios.post(url,inputValue)
        .then( resp => { console.log(resp); alert("Data Submitted successfully... Thank you !!"); } )
        .catch( err => console.log(err) );
        nav("/checkout9", { state:inputValue});
    }  
    ...
    useEffect(()=> {
        ...
        useEffect(()=> {
          axios.get(`/api/planedata/`+params.id)
          .then(res => {
              console.log(res)
...
<b style={{ padding:'10px' }}> <Link to={'/'}> Home </Link> / <Link to={'/planelist/'}> Products </Link> /</b> 
    ...
    data.map((item)=>
                <li>
                 <div class="uk-card uk-card-default">
                    ...
                    <a href={'/planedetailpage/' + item.id}><img src={'/uploads/plane/'+item.photo} width="1800" height="1200" alt="oyt" /></a>
                    ...
                    <a href={'/planedetailpage/' + item.id}><h5 class="uk-card-title"> {capitalizeWords(item.name)} </h5></a>
...
<select type="select" name="adult" value={inputValue.gender} onChange={handleInput} class="form-control" id="adult" style={{fontSize:'14px'}}>
...
<select type="select" name="child" value={inputValue.gender} onChange={handleInput} class="form-control" id="child" style={{fontSize:'14px'}}>
<option value="1">01</option>
<option value="2">02</option>
<option value="3">03</option>
<option value="4">04</option>
...
<select type="select" name="from_location" value={inputValue.gender} onChange={handleInput} class="form-control" id="from_location" style={{fontSize:'14px'}}>
...
<select type="select" name="to_location" value={inputValue.gender} onChange={handleInput} class="form-control" id="to_location" style={{fontSize:'14px'}}>
<option value="Delhi">Delhi</option>
<option value="Uttar Pradesh">Uttar Pradesh</option>
<option value="Maharastra">Maharastra</option>
<option value="Kerla">Kerla</option>
