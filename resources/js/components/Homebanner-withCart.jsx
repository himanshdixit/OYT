...
import Item_caravan from './Item_caravan'
import Item_wedding from './Item_wedding'
import Item_wine from './Item_wine'
import Item_resort from './Item_resort'
import Item_golf from './Item_golf'
import Item_holiday from './Item_holiday'
import Item_honeymoon from './Item_honeymoon'
import Item_plane from './Item_plane'
import Item_hotel from './Item_hotel'
...
name={capitalizeWords(item.name)}
price={item.price}
image={'/uploads/resort/'+item.photo}
/>
</li>
)
}
...
<div className='phoneContent' style={{background: 'url("images/backgrounds/bg3.jpg")'}}>
<div class="col-12">
	<div>
	<h1 style={{textAlign:'center',marginTop:'0',fontFamily:"'Comfortaa', sans-serif"}}>&nbsp; WELLNESS RESORTS &nbsp;
	</h1>
...
name={capitalizeWords(item.name)}
price={item.price}
image={'/uploads/caravan/'+item.photo}
/>
</li>
)
}
...
name={capitalizeWords(item.name)}
price={item.price}
image={'/uploads/plane/'+item.photo}
/>
</li>
)
}
...
name={capitalizeWords(item.name)}
price={item.price}
image={'/uploads/weddings/'+item.photo}
/>
</li>
)
}
...
name={capitalizeWords(item.name)}
price={item.price}
image={'/uploads/honeymoon/'+item.photo}
/>
</li>
)
}
...
name={capitalizeWords(item.name)}
price={item.price}
image={'/uploads/hotels/'+item.photo}
/>
</li>
)
}
