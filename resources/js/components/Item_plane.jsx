...
function Item_plane({id, p_id, name, image, price}) {
...
<div class="uk-card-media-top">
    <Link to={'/planedetailpage/' + p_id}><img src={image} width="1800" height="1200" alt="oyt" /></Link>
...
<Link to={'/planedetailpage/' + p_id}><h5 class="uk-card-title"> {name} </h5></Link>
