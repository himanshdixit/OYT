...
<>
<Link style={{ color:'white' }} to="/signup" onClick={this.logout}> &nbsp;&nbsp; Logout &nbsp;&nbsp; | </Link><Link style={{ color:'white' }} to="/profile"> &nbsp;&nbsp; {this.user.data.name.toUpperCase()} &nbsp;&nbsp; | </Link>  
</>
:
<>
...
<button style={{ border:'2px solid #3c77c9'}} type="button" data-toggle="collapse" data-target="#navbarContent" aria-controls="navbars" aria-expanded="false" aria-label="Toggle navigation" className="navbar-toggler">
    ...
    <div id="navbarContent" className={this.state.clicked ? "knav navbar-collapse collapse show" : "collapse knav navbar-collapse"} onClick={this.handleClick} style={{lineHeight: '40px'}}>
...
<div className='phoneContent'>
{
  localStorage.getItem('user-info')?
<>
<Link style={{ color:'rgb(60, 119, 201)' }} to="/signup" onClick={this.logout}> &nbsp;&nbsp; Sign out &nbsp;&nbsp; | </Link><Link style={{ color:'rgb(60, 119, 201)' }} to="/profile"> &nbsp;&nbsp; {this.user.data.name.toUpperCase()} &nbsp;&nbsp; </Link>  
</>
:
<>
<Link style={{ color:'rgb(60, 119, 201)' }} to="/login"> &nbsp;&nbsp; Sign In &nbsp;&nbsp; | </Link><Link style={{ color:'rgb(60, 119, 201)' }} to="/signup"> &nbsp;&nbsp; Sign Up &nbsp;&nbsp; </Link>
</>
