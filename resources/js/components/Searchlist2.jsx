...
useEffect(()=> {
    axios.get(`/api/searchCruises/`+data.destination+"/"+data.name)
    .then(res => {
        console.log(res)
...
slider.oninput = function() {
  ...
  <div class="card" style={{borderRadius:'0',border:'0'}}>
    ...
    <input type="radio" value="value1" name="group2" style={{margin:'5px'}}/>&nbsp; cruises &nbsp; <br/>
...
<b style={{ paddingLeft:'10px' }}><Link to={'/'}>Home /</Link></b><Link to={'/'}><b> Products</b></Link> <b style={{color:'rgb(255, 61, 0)'}}>/   cruises</b>
</div>
</div>
...
&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-cruise" style={{color:'#ff3d00'}}>&nbsp; Enjoy Your Flight</i>
...
<Link to={'/cruisedetailpage/' + item.id}>
