...
const Hoteldetailpage=()=>{
  ...
  function getDate() {
    ...
    const handleSubmit= async (e)=>{
      ...
      // const url="http://localhost:8000/api/hotel_booking";
      const url="https://oyt.travel/api/hotel_booking";
      const res = await axios.post(url,inputValue)
        .then( resp => { console.log(resp); alert("Data Submitted successfully... Thank you !!");} )
        .catch( err => console.log(err) );
        nav("/checkout1", { state:inputValue});
    }  
    ...
    useEffect(()=> {
        ...
        useEffect(()=> {
          axios.get(`/api/hoteldata/`+params.id)
          .then(res => {
              console.log(res)
...
<b style={{ padding:'10px' }}> <Link to={'/'}> Home </Link> / <Link to={'/hotellist/'}> Products </Link> /</b> 
    ...
    data.map((item)=>
                <li>
                 <div class="uk-card uk-card-default">
                    ...
                    <a href={'/hoteldetailpage/' + item.id}><img src={'/uploads/hotels/'+item.photo} width="1800" height="1200" alt="oyt" /></a>
                    ...
                    <a href={'/hoteldetailpage/' + item.id}><h5 class="uk-card-title"> {capitalizeWords(item.name)} </h5></a>
...
<input type="text" name="address" value={inputValue.address} onChange={handleInput} class="form-control" id="address" style={{fontSize:'14px'}} />
</div>
</div>

<div class="col-12">
<div class="form-group">
<label style={{fontSize:'14px'}}>Room Type</label>
