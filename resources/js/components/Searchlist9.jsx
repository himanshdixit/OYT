...
useEffect(()=> {
    axios.get(`/api/searchPlanes/`+data.source+"/"+data.destination+"/"+data.name)
    .then(res => {
        console.log(res)
...
slider.oninput = function() {
  ...
  <div class="card" style={{borderRadius:'0',border:'0'}}>
    ...
    <input type="radio" value="value1" name="group2" style={{margin:'5px'}}/>&nbsp; Planes &nbsp; <br/>
...
<img src="images/pagebanners/planepc.jpg" class="img-fluid" style={{width:'100%',marginTop:'70px'}} alt="oyt" />
</div>
<div className='phoneContent'>
<img src="images/pagebanners/planemb.jpg" class="img-fluid" style={{width:'100%'}} alt="oyt" />
</div>
...
<b style={{ paddingLeft:'10px' }}><Link to={'/'}>Home /</Link></b><Link to={'/'}><b> Products</b></Link> <b style={{color:'rgb(255, 61, 0)'}}>/ Charted Planes</b>
</div>
</div>
...
slider.oninput = function() {
  ...
  <div class="card" style={{borderRadius:'0',border:'0'}}>
	...
	<fieldset id="group2" style={{marginBottom:'2px'}}>
    <input type="radio" value="value1" name="group2" style={{margin:'5px'}}/>&nbsp; Appartments &nbsp; <br/>
    <input type="radio" value="value1" name="group2" style={{margin:'5px'}}/>&nbsp; Charted Planess &nbsp; <br/>
    <input type="radio" value="value2" name="group2" style={{margin:'5px'}}/>&nbsp; Gest House &nbsp; <br/>
    <input type="radio" value="value3" name="group2" style={{margin:'5px'}}/>&nbsp; Bed & Breakfast &nbsp; <br/>
	<input type="radio" value="value1" name="group2" style={{margin:'5px'}}/>&nbsp; Farm Stay &nbsp;
 	</fieldset>		
...
<div class="col-lg-3">
<div style={{textAlign:'center'}}>
<Link to={'/planedetailpage/' + item.id}><img src={'/uploads/plane/'+item.photo} class="img-fluid" style={{borderRadius:'7px'}} alt="oyt"/>
</Link>
</div>
</div>
<div class="col-lg-6">
...
&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-plane" style={{color:'#ff3d00'}}>&nbsp; Enjoy Your Flight</i>
<p align="justify" style={{margin:'5px',marginBottom:'10px',fontSize:'14px'}}>
{ item.des.replace( /(<([^>]+)>)/ig, '').substring(0, 150) }
<Link to={'/planedetailpage/' + item.id} style={{float:'right',color:'#3c77c9',fontWeight:'600'}}>view details <i class="fa fa-angle-double-right" aria-hidden="true"></i></Link>
</p>
...
<Link to={'/planedetailpage/' + item.id}>
...
<div class="col-lg-6">
<div style={{paddingTop:'7px'}}>
<b style={{color:'#3c77c9'}}>OYT Charted Planes &nbsp;&nbsp; 
<br/><i class="fa fa-star" style={{color:'#ff3d00',margin:'2px'}}></i><i class="fa fa-star" style={{color:'#ff3d00',margin:'2px'}}></i><i class="fa fa-star" style={{color:'#ff3d00',margin:'2px'}}></i><i class="fa fa-star" style={{color:'lightgrey',margin:'2px'}}></i><i class="fa fa-star" style={{color:'lightgrey',margin:'2px'}}></i></b>
