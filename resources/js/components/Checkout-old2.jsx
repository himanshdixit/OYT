...
if("CRUISE"==params.type){
  useEffect(()=> {
    axios.get(`/api/cruisedetails/`+data.cruise_id)
    .then(res => {
        console.log(res)
...
else if("WEDDING"==params.type){

  useEffect(()=> {
    axios.get(`/api/weddingdetails/`+data.w_id)
    .then(res => {
        console.log(res)
        // console.log(res.data.blog[0].name)
        setPosts(res.data.data)
...
else if("WINE"==params.type){

  useEffect(()=> {
    axios.get(`/api/winedetails/`+data.wi_id)
    .then(res => {
        console.log(res)
        // console.log(res.data.blog[0].name)
        setPosts(res.data.data)
...
else if("CARAVAN"==params.type){

  useEffect(()=> {
    axios.get(`/api/caravandetails/`+data.cr_id)
    .then(res => {
        console.log(res)
        // console.log(res.data.blog[0].name)
        setPosts(res.data.data)
...
else if("HONEYMOON"==params.type){

  useEffect(()=> {
    axios.get(`/api/honeymoondetails/`+data.hy_id)
    .then(res => {
        console.log(res)
        // console.log(res.data.blog[0].name)
        setPosts(res.data.data)
...
else if("HOLIDAY"==params.type){

  useEffect(()=> {
    axios.get(`/api/holidaydetails/`+data.h_id)
    .then(res => {
        console.log(res)
        // console.log(res.data.blog[0].name)
        setPosts(res.data.data)
...
else if("RESORT"==params.type){

  useEffect(()=> {
    axios.get(`/api/resortdetails/`+data.r_id)
    .then(res => {
        console.log(res)
        // console.log(res.data.blog[0].name)
        setPosts(res.data.data)
...
else if("PLANE"==params.type){

  useEffect(()=> {
    axios.get(`/api/planedetails/`+data.p_id)
    .then(res => {
        console.log(res)
        // console.log(res.data.blog[0].name)
        setPosts(res.data.data)
...
else if("GOLF"==params.type){

  useEffect(()=> {
    axios.get(`/api/golfdetails/`+data.g_id)
    .then(res => {
        console.log(res)
        // console.log(res.data.blog[0].name)
        setPosts(res.data.data)
...
<img src={'/uploads/cruise_items/'+item.image} class="img-fluid" style={{width:'auto',height:'auto',borderRadius:'1%',marginBottom:'10px'}} alt="oyt"/>
