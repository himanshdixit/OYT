...
useEffect(()=> {
    axios.get(`/api/searchHotels/`+data.location)
    .then(res => {
        console.log(res)
...
<div class="uk-inline">
        <button class="btn btn-outline-primary uk-button-default icon-floatp" type="button"> <i class="fa fa-filter"></i> </button>
        <div class="uk-card uk-card-body uk-card-default" style={{padding:'5px'}} uk-drop="animation: reveal-left; animate-out: true; duration: 500">

	
	<div class="" style={{backgroundColor:'#fbfbfb',marginTop:'5px',borderRadius:'5px',border:'1px solid lightgrey'}}>
...
<img src="images/pagebanners/hotelpc.jpg" class="img-fluid" style={{width:'100%',marginTop:'70px'}} alt="oyt" />
</div>
<div className='phoneContent'>
<img src="images/pagebanners/hotelmb.jpg" class="img-fluid" style={{width:'100%'}} alt="oyt" />
</div>
...
<b style={{ paddingLeft:'10px' }}><Link to={'/'}>Home /</Link></b><Link to={'/'}><b> Products</b></Link> <b style={{color:'rgb(255, 61, 0)'}}>/ Hotels</b> 
</div>
</div>
...
<div class="col-lg-3">
<div style={{textAlign:'center'}}>
<Link to={'/hoteldetailpage/' + item.id}><img src={'/uploads/hotels/'+item.photo} class="img-fluid" style={{borderRadius:'7px'}} alt="oyt"/>
</Link>
</div>
</div>
<div class="col-lg-6">
...
&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-map-marker" style={{color:'#ff3d00'}}>&nbsp; { item.location } </i>
<p align="justify" style={{margin:'5px',marginBottom:'10px',fontSize:'14px'}}>
{ item.overview.replace( /(<([^>]+)>)/ig, '').substring(0, 150) }
<Link to={'/hoteldetailpage/' + item.id} style={{float:'right',color:'#3c77c9',fontWeight:'600'}}>view details <i class="fa fa-angle-double-right" aria-hidden="true"></i></Link>
</p>
