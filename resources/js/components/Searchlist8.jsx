...
useEffect(()=> {
    axios.get(`/api/searchResorts/`+data.location+"/"+data.name)
    .then(res => {
        console.log(res)
...
slider.oninput = function() {
  ...
  <div class="card" style={{borderRadius:'0',border:'0'}}>
    ...
    <input type="radio" value="value1" name="group2" style={{margin:'5px'}}/>&nbsp; Resortss &nbsp; <br/>
...
<img src="images/pagebanners/resortpc.jpg" class="img-fluid" style={{width:'100%',marginTop:'70px'}} alt="oyt" />
</div>
<div className='phoneContent'>
<img src="images/pagebanners/resortmb.jpg" class="img-fluid" style={{width:'100%'}} alt="oyt" />
</div>
...
<b style={{ paddingLeft:'10px' }}><Link to={'/'}>Home /</Link></b><Link to={'/'}><b> Products</b></Link> <b style={{color:'rgb(255, 61, 0)'}}>/ Resorts</b>
</div>
</div>
...
<div class="col-lg-3">
<div style={{textAlign:'center'}}>
<Link to={'/resortdetailpage/' + item.id}><img src={'/uploads/resort/'+item.photo} class="img-fluid" style={{borderRadius:'7px'}} alt="oyt"/>
</Link>
</div>
</div>
<div class="col-lg-6">
...
<Link to={'/resortdetailpage/' + item.id} style={{float:'right',color:'#3c77c9',fontWeight:'600'}}>view details <i class="fa fa-angle-double-right" aria-hidden="true"></i></Link>
</p>
...
<Link to={'/resortdetailpage/' + item.id}>
...
<div class="col-lg-6">
<div style={{paddingTop:'7px'}}>
<b style={{color:'#3c77c9'}}>OYT resorts &nbsp;&nbsp; 
<br/><i class="fa fa-star" style={{color:'#ff3d00',margin:'2px'}}></i><i class="fa fa-star" style={{color:'#ff3d00',margin:'2px'}}></i><i class="fa fa-star" style={{color:'#ff3d00',margin:'2px'}}></i><i class="fa fa-star" style={{color:'lightgrey',margin:'2px'}}></i><i class="fa fa-star" style={{color:'lightgrey',margin:'2px'}}></i></b>
