...
<b style={{ padding:'10px' }}> <Link to={'/'}> Home </Link> / <Link to={'/honeymoonlist/'}> Listing </Link> </b>  
</div>
</div>
...
<h4 style={{marginTop:'10px',fontWeight:'700',color:'#3c77c9',lineHeight:'1',marginBottom:'10px'}}>Honeymoons</h4>
...
<form action="{{ url('Honeymoons_booking_form') }}" name="HoneymoonsbookingForm" method="post" onsubmit="return validateform()" enctype="multipart/form-data" class="info-box">
