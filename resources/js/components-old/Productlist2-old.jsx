...
<img src="images/pagebanners/cruisepc.jpg" class="img-fluid" style={{width:'100%',marginTop:'70px'}} alt="oyt" />
</div>
<div className='phoneContent'>
<img src="images/pagebanners/cruisemb.jpg" class="img-fluid" style={{width:'100%'}} alt="oyt" />
</div>
...
slider.oninput = function() {
  ...
  <div class="card" style={{borderRadius:'0',border:'0'}}>
    ...
    <input type="radio" value="value1" name="group2" style={{margin:'5px'}}/>&nbsp; Cruisess &nbsp; <br/>
...
<div class="col-lg-3">
<div style={{textAlign:'center'}}>
<Link to={'/cruisedetailpage/' + item.id}><img src={'/uploads/cruise_items/'+item.image} class="img-fluid" style={{borderRadius:'7px'}} alt="oyt"/>
</Link>
</div>
</div>
<div class="col-lg-6">
...
&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-plus" style={{color:'#ff3d00'}}>&nbsp; {item.sailing_dates}</i>
<p align="justify" style={{margin:'5px',marginBottom:'10px',fontSize:'14px'}}>
{ item.des.replace( /(<([^>]+)>)/ig, '').substring(0, 150) }
<Link to={'/cruisedetailpage/' + item.id} style={{float:'right',color:'#3c77c9',fontWeight:'600'}}>view details <i class="fa fa-angle-double-right" aria-hidden="true"></i></Link>
</p>
...
width:'0',
float:'right',
borderBottom: 'solid 2.3em transparent',
borderRight: 'solid 1.7em #ff3d00',
borderTop: 'solid 2.3em transparent'
}}>
</div>
</div>
<div class="col-10" style={{paddingLeft:'0'}}>
<div style={{backgroundColor:'#f75724',height:'100%',padding:'6% 1% 1% 1%',marginTop:'1px',borderBottomRightRadius:'10px',borderTopRightRadius:'10px'}}>
<b style={{ textAlign:'left',fontSize:'1.2rem',marginTop:'5%',color:'#fff' }}><i class="fa fa-inr" aria-hidden="true" style={{fontSize:'1.5rem',color:'#fff'}}></i>&nbsp;{ item.price }/-</b>
&nbsp;&nbsp;<button className="btn btn-primary" style={{ textAlign:'right',borderBottomRightRadius:'10px',borderTopRightRadius:'10px' }}>Book now</button>
</div>
<span style={{
fontSize: '14px',
    color: '#fff',
...
<div class="col-lg-6">
<div style={{paddingTop:'7px'}}>
<b style={{color:'#3c77c9'}}>OYT Cruises &nbsp;&nbsp; 
<br/><i class="fa fa-star" style={{color:'#ff3d00',margin:'2px'}}></i><i class="fa fa-star" style={{color:'#ff3d00',margin:'2px'}}></i><i class="fa fa-star" style={{color:'#ff3d00',margin:'2px'}}></i><i class="fa fa-star" style={{color:'lightgrey',margin:'2px'}}></i><i class="fa fa-star" style={{color:'lightgrey',margin:'2px'}}></i></b>
