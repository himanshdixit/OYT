...
<div class="uk-position-relative uk-visible-toggle uk-light deskContent" style={{ maxHeight:'460px',marginTop:'98px  '}} tabindex="-1" uk-slideshow="animation: fade;autoplay: true;">
...
<div class="uk-position-relative uk-visible-toggle uk-light phoneContent" style={{ maxHeight:'120px'}} tabindex="-1" uk-slideshow="animation: fade;autoplay: true;">
    <ul class="uk-slideshow-items">
        <li>
            <img src={b1} alt="oyt" uk-cover />
        </li>
...
<div class="row">
<div class="uk-slider-container nopdding" uk-slider="autoplay:true;autoplay-interval: 6000;pause-on-hover: true;" style={{ marginTop:'5px'}}>
    <div class="uk-position-relative uk-visible-toggle uk-light" tabindex="-1">
...
<br/>
<div class="row">
<div class="uk-slider-container nopdding" uk-slider="autoplay:true;autoplay-interval: 6000;pause-on-hover: true;" style={{ marginTop:'1px'}}>
    <div class="uk-position-relative uk-visible-toggle uk-light" tabindex="-1">
        <ul class="uk-slider-items uk-child-width-1-2 uk-child-width-1-3@s uk-child-width-1-4@m uk-child-width-1-4@l uk-grid">
