...
<b style={{ padding:'10px' }}> <Link to={'/'}> Home </Link> / <Link to={'/golflist/'}> Listing </Link> </b>  
</div>
</div>
...
<h4 style={{marginTop:'10px',fontWeight:'700',color:'#3c77c9',lineHeight:'1',marginBottom:'10px'}}>Golfs</h4>
...
<form action="{{ url('Golfs_booking_form') }}" name="GolfsbookingForm" method="post" onsubmit="return validateform()" enctype="multipart/form-data" class="info-box">
...
<select type="select" name="player" class="form-control" id="player" style={{fontSize:'14px'}}>
...
<select type="select" name="timing" class="form-control" id="timing" style={{fontSize:'14px'}}>
