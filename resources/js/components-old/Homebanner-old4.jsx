...
{/* <!-- -----------------------------------Start -------------- --> */}
<div style={{backgroundColor: 'rgb(245, 245, 245)',borderTop: '1px solid lightgrey',borderBottom: '1px solid lightgrey',paddingLeft:'50px',paddingRight:'50px',paddingTop:'10px',paddingBottom:'10px'}}>
<div class="container">
<div class="row">

<div class="col-lg-2 col-md-6 col-xs-6 col-4">
<div style={{textAlign:'center'}}><img src={cruise} class="img-fluid" style={{maxHeight:'80px',width:'auto'}} />
<br/><span>Cruise</span>
</div>
</div>

<div class="col-lg-2 col-md-6 col-xs-6 col-4">
<div style={{textAlign:'center'}}><img src={caravan} class="img-fluid" style={{maxHeight:'80px',width:'auto'}} />
<br/><span>Caravan</span>
</div>
</div>

<div class="col-lg-2 col-md-6 col-xs-6 col-4">
<div style={{textAlign:'center'}}><img src={holiday} class="img-fluid" style={{maxHeight:'80px',width:'auto'}} />
<br/><span>Holiday</span>
</div>
</div>

<div class="col-lg-2 col-md-6 col-xs-6 col-4">
<div style={{textAlign:'center'}}><img src={resort} class="img-fluid" style={{maxHeight:'80px',width:'auto'}} />
<br/><span>Resort</span>
</div>
</div>

<div class="col-lg-2 col-md-6 col-xs-6 col-4">
<div style={{textAlign:'center'}}><img src={wedding} class="img-fluid" style={{maxHeight:'80px',width:'auto'}} />
<br/><span>Wedding</span>
</div>
</div>

<div class="col-lg-2 col-md-6 col-xs-6 col-4">
<div style={{textAlign:'center'}}><img src={wine} class="img-fluid" style={{maxHeight:'80px',width:'auto'}} />
<br/><span>Wine</span>
</div>
</div>
...
<b style={{textAlign:'center',marginTop:'15px',marginBottom:'30px  ',color:'#3c77c9  ',fontSize:'3rem', fontFamily:'Times New Roman'}}>&nbsp; Why Travel with OYT ? &nbsp;
</b>
</div>
<br/>
...
<b style={{textAlign:'center',marginTop:'15px',marginBottom:'30px  ',color:'#3c77c9  ',fontSize:'1.8rem',fontFamily:'Times New Roman'}}>&nbsp; Why Travel with OYT ? &nbsp;</b>
</div>
...
<b>Cart || </b> &nbsp; 
<i class="fa fa-shopping-cart"> &nbsp; {5} </i>
...
{/* <li>
                 <div class="uk-card uk-card-default nopadding">
                    <div class="uk-card-media-top">
                        <img src="images/cr1.jpg" width="1800" height="1200" alt="" />
						<b class="cardicontxt">New</b>
						<i class="fa fa fa-eye cardicon1"></i>
						<i class="fa fa-shopping-cart cardicon2"></i>
                    </div>
    ...
    <p class="card-text" style={{marginBottom:'2px',marginTop: '5px',fontSize:'14px',color:'#3c77c9'}}><b class="price">Rs. 9000/- </b>price <a href="#"><i class="fa fa-long-arrow-right cardlink" style={{color:'#f5640a',marginTop:'3px',float:'right'}}></i></a></p>
            ...
            <li>
                 <div class="uk-card uk-card-default nopadding">
                    <div class="uk-card-media-top">
                        <img src="images/cr2.jpg" width="1800" height="1200" alt="" />
						<b class="cardicontxt">New</b>
						<i class="fa fa fa-eye cardicon1"></i>
						<i class="fa fa-shopping-cart cardicon2"></i>
                    </div>
    ...
    <p class="card-text" style={{marginBottom:'2px',marginTop: '5px',fontSize:'14px',color:'#3c77c9'}}><b class="price">Rs. 9000/- </b>price <a href="#"><i class="fa fa-long-arrow-right cardlink" style={{color:'#f5640a',marginTop:'3px',float:'right'}}></i></a></p>
            ...
            <li>
                 <div class="uk-card uk-card-default nopadding">
                    <div class="uk-card-media-top">
                        <img src="images/hotels3.jpg" width="1800" height="1200" alt="" />
						<b class="cardicontxt">New</b>
						<i class="fa fa fa-eye cardicon1"></i>
						<i class="fa fa-shopping-cart cardicon2"></i>
                    </div>
    ...
    <p class="card-text" style={{marginBottom:'2px',marginTop: '5px',fontSize:'14px',color:'#3c77c9'}}><b class="price">Rs. 9000/- </b>price <a href="#"><i class="fa fa-long-arrow-right cardlink" style={{color:'#f5640a',marginTop:'3px',float:'right'}}></i></a></p>
            ...
            <li>
                 <div class="uk-card uk-card-default">
                    <div class="uk-card-media-top">
                        <img src="images/re1.jpg" width="1800" height="1200" alt="" />
						<b class="cardicontxt">New</b>
						<i class="fa fa fa-eye cardicon1"></i>
						<i class="fa fa-shopping-cart cardicon2"></i>
                    </div>
...
<div className='deskContent'>
<img class="img-fluid" src="images/banner2new.jpg" style={{width:'auto',marginTop:'5px',marginBottom:'5px',borderRadius: '7px  '}} alt="oyt" />
</div>
{/* <div className='phoneContent'>
<img src="images/pagebanners/hotelmbnew.jpg" class="img-fluid" style={{width:'100%'}} alt="oyt" />
</div> */}
<div className='phoneContent'>
<img src="images/banner2new.jpg" class="img-fluid" style={{width:'100%'}} alt="oyt" />
</div>
...
<div class="uk-slider-container" uk-slider="autoplay:true;autoplay-interval: 6000;pause-on-hover: true;" style={{ marginTop:'1px'}}>
    ...
    <p class="card-text" style={{marginBottom:'2px',marginTop: '5px',fontSize:'14px',color:'#3c77c9'}}><b class="price">Rs. 9000/- </b>price <a href="#"><i class="fa fa-long-arrow-right cardlink" style={{color:'#f5640a',marginTop:'3px',float:'right'}}></i></a></p>
            ...
            <li>
                 <div class="uk-card uk-card-default">
                    <div class="uk-card-media-top">
                        <img src="images/wed1.jpg" width="1800" height="1200" alt="" />
						<b class="cardicontxt">New</b>
						<i class="fa fa fa-eye cardicon1"></i>
						<i class="fa fa-shopping-cart cardicon2"></i>
                    </div>
...
{/* 
{
    data101.map((item)=>   
<div class="col-6 nopddingL">
      <img src={'/uploads/golf/'+item.photo} class="img-fluid" style={{borderRadius:'7px 7px 1px 1px  '}} alt="OYT"/>
	  <div>
		<div class="myicons">
		<i class="fa fa-shopping-cart myicons2"></i>
		<i class="fa fa fa-eye myicons1"></i>
...
{/* <!-- -----------------------------------Start NEWS -------------- -->	 */}
<div style={{ textAlign:'center'}}>
<img src="images/photo2.jpg" class="img-fluid" style={{height:'100px',width:'auto',borderTopLeftRadius:'10px',borderBottomLeftRadius:'10px'}}/>
</div>
{/* <!-- -----------------------------------END NEWS -------------- -->	 */}
