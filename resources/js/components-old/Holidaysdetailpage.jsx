...
<b style={{ padding:'10px' }}> <Link to={'/'}> Home </Link> / <Link to={'/holidaylist/'}> Listing </Link> </b>  
</div>
</div>
    ...
    data.map((item)=>
                <li>
                 <div class="uk-card uk-card-default">
                    ...
                    <Link to={'/holidaysdetailpage/' + item.id}> <img src={'/uploads/holiday/'+item.photo} width="1800" height="1200" alt="oyt" /></Link>
                    ...
                    <Link to={'/holidaysdetailpage/' + item.id}><h5 class="uk-card-title">{capitalizeWords(item.name)} </h5></Link>
...
<form action="{{ url('Holidays_booking_form') }}" name="HolidaysbookingForm" method="post" onsubmit="return validateform()" enctype="multipart/form-data" class="info-box">
...
<select type="select" name="services" class="form-control" id="services" style={{fontSize:'14px'}}>
