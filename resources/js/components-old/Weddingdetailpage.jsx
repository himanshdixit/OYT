...
<b style={{ padding:'10px' }}> <Link to={'/'}> Home </Link> / <Link to={'/weddinglist/'}> Listing </Link> </b>  
</div>
</div>
...
<form action="{{ url('Weddings_booking_form') }}" name="WeddingsbookingForm" method="post" onsubmit="return validateform()" enctype="multipart/form-data" class="info-box">
...
<input type="date" name="wedding_date" class="form-control" id="wedding_date" style={{fontSize:'14px'}} />
</div>
</div>
<div class="col-6">
 <div class="form-group">
<label style={{fontSize:'14px'}}>Program Starting Time</label>
<input type="time" name="wedding_time" class="form-control" id="wedding_time" style={{fontSize:'14px'}} />
</div>
</div>
</div>
...
<select type="select" name="people" class="form-control" id="people" style={{fontSize:'14px'}}>
...
<select type="select" name="food_pax_type" class="form-control" id="food_pax_type" style={{fontSize:'14px'}}>
