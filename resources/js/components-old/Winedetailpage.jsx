...
<b style={{ padding:'10px' }}> <Link to={'/'}> Home </Link> / <Link to={'/winelist/'}> Listing </Link> </b>  
</div>
</div>
...
<select type="select" name="quantity" class="form-control" id="quantity" style={{fontSize:'14px'}}>
...
<select type="select" name="pack" class="form-control" id="pack" style={{fontSize:'14px'}}>
