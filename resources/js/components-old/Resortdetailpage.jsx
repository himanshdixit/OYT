...
<b style={{ padding:'10px' }}> <Link to={'/'}> Home </Link> / <Link to={'/resortlist/'}> Listing </Link> </b>  
</div>
</div>
...
<form action="{{ url('Resorts_booking_form') }}" name="ResortsbookingForm" method="post" onsubmit="return validateform()" enctype="multipart/form-data" class="info-box">
...
<select type="select" name="type" class="form-control" id="type" style={{fontSize:'14px'}}>
...
<select type="select" name="food" class="form-control" id="food" style={{fontSize:'14px'}}>
