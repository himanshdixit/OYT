...
<b style={{ padding:'10px' }}> <Link to={'/'}> Home </Link> / <Link to={'/caravanlist/'}> Listing </Link> </b>  
</div>
</div>
...
<form action="{{ url('wine_booking_form') }}" name="winebookingForm" method="post" onsubmit="return validateform()" enctype="multipart/form-data" class="info-box">
...
<select type="select" name="pickup_location" class="form-control" id="pickup_location" style={{fontSize:'14px'}}>
...
<select type="select" name="drop_location" class="form-control" id="drop_location" style={{fontSize:'14px'}}>
<option value="Delhi">Delhi</option>
<option value="Uttar Pradesh">Uttar Pradesh</option>
<option value="Maharastra">Maharastra</option>
<option value="Kerla">Kerla</option>
...
<select type="select" name="driver" class="form-control" id="driver" style={{fontSize:'14px'}}>
